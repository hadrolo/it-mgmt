import {FwLoginType, FwMode, FwSettingAuthType, FwSettings, FwUniverseType, FwUserDisplayStyle} from './services/settings.service';
...
export const universeConfig: FwSettings = {
    production: environment.production,
    apiUrl: environment.apiUrlUniverse,
    frameworkMode: FwMode.UNIVERSE,
    appID: 'it-mgmt',
    appName: 'IT-Mgmt',
