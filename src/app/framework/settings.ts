...
export const standaloneConfig: FwSettings = {
    ...
    apiUrl: FwApiUrl.STANDALONE,
    frameworkMode: FwMode.STANDALONE,
    appID: 'mgmt',
    appName: 'Mgmt',
    ...
    auth: {
        ...
        register: {
            ...
            rows: [
                ...
                {
                    valueTrans: 'FW.REGISTER.REAL_NAME_VISIBLE_FOR',
                    field: 'realname_visible',
                    type: 'enum',
                    required: true,
                    values: [
                        {key: 'all', value: 'REGISTER.ALL'},
                        {key: 'registered', value: 'REGISTER.REGISTERED'},
                        {key: 'nobody', value: 'REGISTER.NOBODY'}
                    ],
                },
                {
                    valueTrans: 'FW.REGISTER.ADDRESS_VISIBLE_FOR',
                    field: 'address_visible',
                    type: 'enum',
                    required: true,
                    values: [
                        {key: 'all', value: 'REGISTER.ALL'},
                ...
                {
                    valueTrans: 'FW.REGISTER.EMAIL_VISIBLE_FOR',
                    field: 'email_visible',
                    type: 'enum',
                    required: true,
                    values: [
